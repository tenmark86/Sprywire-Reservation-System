    ...
    <center>
        <div class="col-sm-6">
            <div class="container">
                ...
                <form action="change_flight2.php" method="post" class="formst">
                    <div class="row mb-3 formele">
                        <label class="col-sm-4 col-form-label labeltxt">ENTER THE FID TO CHANGE</label>
                        <div class="col-sm-5">
                    ...
                    <div class="col-sm-2 row mb-3 float-left">
                        <button type="submit" name="SubmitButton" value="submit" class="btn btn-outline-dark btn-lg but">MODIFY</button>
                    </div>
                  </form>
