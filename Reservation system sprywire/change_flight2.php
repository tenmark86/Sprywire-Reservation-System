...
<head>
    ...
    <title>kisumu Internatinal Airport : MODIFY FLIGHT </title>
...
<body>
    ...
    if($r->num_rows==1){
     ...
     echo "<form action=\"change_flight3.php\" method=\"post\" class=\"formst\">
    <div class=\"row mb-3 formele\">
        <label class=\"col-sm-4 col-form-label labeltxt\">AID</label>
        <div class=\"col-sm-5\">
            <input type=\"text\" class=\"form-control\" name=\"aid\" required value = '".$row['AID']."'>
        </div>
    </div>
    <div class=\"col-sm-2 row mb-3 float-left\">
        <button type=\"submit\" name=\"SubmitButton2\" value=\"submit\" class=\"btn btn-outline-dark btn-lg but\">MODIFY</button>
    </div>
    </form>
